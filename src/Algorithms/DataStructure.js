...
export const getGraphLinkedList = (nodes, arrows, directed=true) => {
    ...
    arrows.forEach(arrow => {
        ...
        if(!directed){
            ...
            linked_list[arrow.endID].push({endID: arrow.startID, weight: arrow.weight, arrowID: arrow.id, nodex1:arrow.nodex2, nodex2:arrow.nodex1, nodey1:arrow.nodey2, nodey2:arrow.nodey1});
        }
    });
