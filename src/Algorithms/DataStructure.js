...
export const getNodeLinkedList = (nodes, arrows, directed=true) => {
    ...
    arrows.forEach(arrow => {
        linked_list[arrow.startID].push({endID: arrow.endID, weight: arrow.weight});
        if(!directed){
            linked_list[arrow.endID].push({endID: arrow.startID, weight: arrow.weight});
        }
    });
